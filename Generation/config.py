...
data_root_part = root+"/dataset/Generation/shapenetcore_partanno_segmentation_benchmark_v0/"
data_root_h5 = os.path.join(root, 'train_h5')
...
parser.add_argument('--exp_name', default='gen_results')
...
parser.add_argument('--choice', default='all', help='choice class')
...
parser.add_argument('--category', type=str, default="all", help="write if want to use specific category ('airplane', 'car', 'chair', 'guitar', 'table')")
parser.add_argument('--gpu', type=str, default="0", help="gpus to use")
parser.add_argument('--train_test_mode', type=str, default="0", help="trainmode")


opts = parser.parse_args()


opts.pretrain_model_G = '%s_G.pth' % opts.choice
